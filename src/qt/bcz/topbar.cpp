...
#include "qt/bcz/balancebubble.h"
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBcz, ui->labelAmountTopShieldedBcz}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // BCZ Total
    QString totalBcz = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // BCZ
    // Top
    ui->labelAmountTopBcz->setText(totalTransparent);
    ui->labelAmountTopShieldedBcz->setText(totalShielded);
    // Expanded
    ui->labelAmountBcz->setText(totalBcz);
    ui->labelPendingBcz->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureBcz->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
