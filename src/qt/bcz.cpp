...
{
    window = new BCZGUI(networkStyle, nullptr);
...
{
    QMessageBox::critical(nullptr, "Runaway exception", QObject::tr("A fatal error occurred. BCZ can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
