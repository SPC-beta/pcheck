...
public:
     ...
     * BCZ: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    bool CreateCoinstakeOuts(const CBczStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
