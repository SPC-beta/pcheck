...
#ifndef BCZ_SAPLING_OPERATION_H
#define BCZ_SAPLING_OPERATION_H
...
struct SendManyRecipient
{
    ...
    SendManyRecipient(const CKeyID& ownerKey, const CKeyID& stakerKey, const CAmount& amount):
            recipient(new CRecipient(GetScriptForStakeDelegationLOF(stakerKey, ownerKey), amount, false))
    {}
